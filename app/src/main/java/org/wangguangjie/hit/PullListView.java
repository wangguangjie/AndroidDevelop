...
public class PullListView extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         * 头部
         */
        headView = (RelativeLayout) inflater.inflate(R.layout.pulllist_head, null);
         ...
         * 底部
         */
        footView = inflater.inflate(R.layout.pulllist_foot, this, false);
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            case NONE:
                ...
                ivHeadArrow.setImageResource(R.drawable.update_arrow);
